...
1ST VERSION: DID NOT SORT CORRECTLY (SOMEWHAT SORTED) BUT AT LEAST ALL TERMS WERE IN THE "SORTED"
2ND VERSION: SEGMENTATION FAULT
3RD VERSION: ONLY RETURNS THE FIRST TERM AND NOTHING ELSE, RESULTING IN LOSS OF DATA

SUBMITTING FIRST VERSION ONLY AS AT LEAST IT SHOWS THAT OTHER OPERATIONS + BONUS IS WORKING
